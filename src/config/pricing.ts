...
export const COUNTRY_PRICING: Record<string, CountryPricing> = {
  SZ: {
    ...
    discountLabel: 'Launch Special', discountPercent: 80,
  },
  ZA: {
    ...
    discountLabel: 'Launch Special', discountPercent: 86,
  },
  KE: {
    ...
    discountLabel: 'Launch Special', discountPercent: 75,
  },
  NG: {
    ...
    discountLabel: 'Launch Special', discountPercent: 77,
  },
  GH: {
    ...
    discountLabel: 'Launch Special', discountPercent: 82,
  },
  TZ: {
  ...
  BW: {
    ...
    discountLabel: 'Launch Special', discountPercent: 83,
  },
  MZ: {
